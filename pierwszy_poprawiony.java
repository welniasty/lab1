...
public class pierwszy_poprawiony {
	public static void main(String[] args){

		punkt_materialny_poprawiony punkt1 = new punkt_materialny_poprawiony(); // stworzenie obiektu o nazwie punkt1 z klasy punkt_materialny
			punkt_materialny_poprawiony punkt2 = new punkt_materialny_poprawiony(5); // stworzenie obiektu o nazwie punkt2 z klasy punkt_materialny i nadanie mu wartoœci poprzez konstruktor
			...
			punkt_materialny_poprawiony[] tablica = new punkt_materialny_poprawiony[5]; //stworzenie tablicy mog¹cej mieœciæ w sobie obiekty klasy punkt_materialny, która na razie jest zainicjowana zerami

			for(int i=0;i<tablica.length;i++){  //pêtla tworz¹ca obiekty i przypisuj¹ca im wartoœci masy za pomoc¹ konstruktora
					
				tablica[i]=new punkt_materialny_poprawiony(i);
